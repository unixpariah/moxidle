...
in
{
  ...
  config = lib.mkIf cfg.enable {
    xdg.configFile = {
      "moxidle/config.lua" = lib.mkIf (cfg.settings != { }) {
        text = ''
          -- Generated by Home Manager
          return ${toLua cfg.settings}
        '';
      };
      "systemd/user/graphical-session.target.wants/moxidle.service".source =
        "${cfg.package}/share/systemd/user/moxidle.service";
    };
